package com.bluetea.entolidemo.circularseekbar;
...
/**
 * Created by KKX on 12.10.2015.
 */
public class DoughterCircularSeekBar extends View {
    ...
    private static final int DEFAULT_POINTER_COLOR = 0; // Color.argb(235, 74, 138, 255);
    private static final int DEFAULT_POINTER_HALO_COLOR = 0; // Color.argb(135, 74, 138, 255);
...
//        mCircleProgressPaint.setStrokeCap(Paint.Cap.ROUND);
    ...
    public DoughterCircularSeekBar(Context context) {
        super(context);
        init(null, 0);
    }

    public DoughterCircularSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public DoughterCircularSeekBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnCircularSeekBarChangeListener {
        ...
        public abstract void onProgressChanged(DoughterCircularSeekBar seekBar, int progress, boolean fromUser);
